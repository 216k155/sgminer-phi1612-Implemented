...
#undef A_DARK
  ...
  { "skunkhash", ALGO_SKUNKHASH, "", 1, 1, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 3, 8 * 16 * 4194304, 0, skunkhash_regenhash, NULL, queue_skunkhash_kernel, gen_hash, append_x11_compiler_options },

  { "phi1612", ALGO_PHI1612, "", 1, 1, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 3, 8 * 16 * 4194304, 0, phi1612_regenhash, NULL, queue_phi1612_kernel, gen_hash, append_x11_compiler_options },
...
#define ALGO_ALIAS(alias, name) \
  ...
  ALGO_ALIAS("thorsriddle", "skunkhash");
  ALGO_ALIAS("thorsriddle", "phi1612");
